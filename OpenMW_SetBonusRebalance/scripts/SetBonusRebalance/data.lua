  ...
  { name = "Iron",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstoshock", mag = 15, condition = { kind = "fatigue", op = "<", value = 0.5, fraction = true } },
      },
      max = {
        ...
        { effect = "weaknesstoshock", mag = 25, condition = { kind = "fatigue", op = "<", value = 0.5, fraction = true } },
      },
    },
  },
  { name = "Steel",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstoshock", mag = 15, condition = { kind = "encumbrance", op = ">=", value = 0.75, fraction = true } },
      },
      max = {
        { effect = "fortifyhealth", mag = 18 },
        { effect = "fortifyattack", mag = 8 },
        { effect = "resistnormalweapons", mag = 12, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
        { effect = "weaknesstoshock", mag = 25, condition = { kind = "encumbrance", op = ">=", value = 0.75, fraction = true } },
      },
    },
  },
  { name = "Ebony",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifyhealth", mag = 8, condition = { kind = "encumbrance", op = ">=", value = 0.75, fraction = true } },
        { effect = "weaknesstoshock", mag = 25, condition = { kind = "encumbrance", op = ">=", value = 0.75, fraction = true } },
      },
    },
  },
  { name = "Daedric",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstofire", mag = 15, condition = { { kind = "health", op = ">", value = 0.75, fraction = true }, { kind = "stance", value = "none" } } },
      },
      max = {
        ...
        { effect = "weaknesstofire", mag = 25, condition = { { kind = "health", op = ">", value = 0.75, fraction = true }, { kind = "stance", value = "none" } } },
      },
    },
  },
  { name = "Dwemer",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstofire", mag = 15, condition = { kind = "sun", value = "up" } },
      },
      max = {
        ...
        { effect = "resistmagicka", mag = 8 },
        { effect = "weaknesstofire", mag = 25, condition = { kind = "sun", value = "up" } },
      },
    },
  },
  { name = "Adamantium",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstoshock", mag = 15, condition = { kind = "magicka", op = ">", value = 0.5, fraction = true } },
      },
      max = {
        { effect = "resistmagicka", mag = 12 },
        { effect = "reflect", mag = 12, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
        { effect = "resistnormalweapons", mag = 8 },
        { effect = "weaknesstoshock", mag = 25, condition = { kind = "magicka", op = ">", value = 0.5, fraction = true } },
      },
    },
  },
  { name = "Orcish",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstomagicka", mag = 15, condition = { kind = "health", op = "<", value = 0.25, fraction = true } },
      },
      max = {
        { effect = "fortifyhealth", mag = 18 },
        ...
        { effect = "weaknesstomagicka", mag = 25, condition = { kind = "health", op = "<", value = 0.25, fraction = true } },
      },
    },
  },
  { name = "Bronze",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstonormalweapons", mag = 15, condition = { kind = "sun", value = "down" } },
      },
      max = {
        { effect = "resistshock", mag = 20 },
        { effect = "resistnormalweapons", mag = 8 },
  ...
  { name = "Silver",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstonormalweapons", mag = 15, condition = { kind = "time", value = "day" } },
      },
      max = {
        { effect = "resistmagicka", mag = 12 },
        { effect = "turnundead", mag = 20 },
        { effect = "spellabsorption", mag = 12, condition = { kind = "time", value = "night" } },
        { effect = "weaknesstonormalweapons", mag = 20, condition = { kind = "time", value = "day" } },
      },
    },
  },
  { name = "Stalhrim",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstofire", mag = 15, condition = { kind = "location", value = "interior" } },
      },
      max = {
        ...
        { effect = "weaknesstofire", mag = 25, condition = { kind = "location", value = "interior" } },
      },
    },
  },
  { name = "Dragonbone",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "fortifyhealth", mag = 12 },
        { effect = "resistnormalweapons", mag = 5 },
        { effect = "weaknesstofrost", mag = 15, condition = { kind = "sun", value = "down" } },
      },
      max = {
        { effect = "resistfire", mag = 20 },
        { effect = "fortifyhealth", mag = 18 },
        ...
        { effect = "fortifyattack", mag = 12, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
        { effect = "resistmagicka", mag = 12 },
        { effect = "weaknesstofrost", mag = 25, condition = { kind = "sun", value = "down" } },
      },
    },
  },
  { name = "Chain Mail",
  ...
  { name = "Gah-Julan",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstonormalweapons", mag = 15, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
      },
      max = {
        { effect = "fortifyfatigue", mag = 28 },
        { effect = "fortifyattack", mag = 12, condition = { kind = "health", op = ">", value = 0.75, fraction = true } },
        { effect = "sanctuary", mag = 8 },
        { effect = "weaknesstonormalweapons", mag = 20, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
      },
    },
  },
  { name = "Armun-An",
  ...
  { name = "Dreugh",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstofrost", mag = 15, condition = { kind = "location", value = "exterior" } },
      },
      max = {
        { effect = "resistshock", mag = 20 },
        { effect = "waterbreathing", mag = 1 },
        ...
        { effect = "reflect", mag = 12, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
        { effect = "weaknesstofrost", mag = 25, condition = { kind = "location", value = "exterior" } },
      },
    },
  },
  { name = "Ring Mail",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstoshock", mag = 15, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
      },
      max = {
        { effect = "fortifyfatigue", mag = 28 },
        ...
        { effect = "weaknesstoshock", mag = 25, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
      },
    },
  },
  { name = "Scale Mail",
  ...
  { name = "Goblin",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstoshock", mag = 15, condition = { kind = "health", op = ">", value = 0.75, fraction = true } },
      },
      max = {
        { effect = "fortifyattribute", attribute = "strength", mag = 8 },
        ...
        { effect = "fortifyfatigue", mag = 28 },
        { effect = "weaknesstoshock", mag = 25, condition = { kind = "health", op = ">", value = 0.75, fraction = true } },
      },
    },
  },
  { name = "Trollbone",
  ...
  { name = "Chitin",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstofrost", mag = 15, condition = { kind = "time", value = "day" } },
      },
      max = {
        ...
        { effect = "weaknesstofrost", mag = 25, condition = { kind = "time", value = "day" } },
      },
    },
  },
  { name = "Glass",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstofrost", mag = 15, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
      },
      max = {
        { effect = "fortifyattribute", attribute = "agility", mag = 8 },
        { effect = "resistfire", mag = 20 },
        ...
        { effect = "weaknesstofrost", mag = 25, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
      },
    },
  },
  { name = "Padded",
  ...
  { name = "Scrap",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstonormalweapons", mag = 15, condition = { kind = "fatigue", op = ">", value = 0.75, fraction = true } },
      },
      max = {
        ...
        { effect = "weaknesstonormalweapons", mag = 20, condition = { kind = "fatigue", op = ">", value = 0.75, fraction = true } },
      },
    },
  },
  { name = "Heavy Armor",
    bonuses = {
      ...
      mid = {
        { effect = "resistnormalweapons", mag = 3 },
        { effect = "fortifyskill", skill = "heavyarmor", mag = 8, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
      },
      max = {
        { effect = "resistnormalweapons", mag = 3 },
        { effect = "fortifyskill", skill = "heavyarmor", mag = 14, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
      },
    },
  },
  { name = "Medium Armor",
    bonuses = {
      ...
      mid = {
        { effect = "fortifyfatigue", mag = 12 },
        { effect = "fortifyskill", skill = "mediumarmor", mag = 8, condition = { kind = "fatigue", op = "<", value = 0.5, fraction = true } },
      },
      max = {
        { effect = "fortifyfatigue", mag = 12 },
        { effect = "fortifyskill", skill = "mediumarmor", mag = 14, condition = { kind = "fatigue", op = "<", value = 0.5, fraction = true } },
  ...
  { name = "Cloth",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstonormalweapons", mag = 15, condition = { kind = "stance", value = "spell" } },
      },
      max = {
        { effect = "restoremagicka", mag = 2, dur = 1 },
        ...
        { effect = "weaknesstonormalweapons", mag = 25, condition = { kind = "stance", value = "spell" } },
      },
    },
  },
  { name = "Nordic",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifyhealth", mag = 12, condition = { kind = "werewolf", value = true } },
      },
    },
  },
  { name = "Imperial",
  ...
  { name = "Bosmer",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifyskill", skill = "marksman", mag = 8, condition = { kind = "encumbrance", op = "<", value = 0.25, fraction = true } },
      },
    },
  },
  { name = "Khajiit",
  ...
  { name = "Orsimer",
    bonuses = {
      ...
      max = {
        ...
        { effect = "restorehealth", mag = 2, dur = 1, condition = { { kind = "werewolf", value = true }, { kind = "health", op = "<", value = 0.5, fraction = true } } },
      },
    },
  },
  { name = "Native",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifyskill", skill = "athletics", mag = 18, condition = { kind = "location", value = "exterior" } },
        { effect = "restorefatigue", mag = 2, dur = 1, condition = { kind = "location", value = "exterior" } },
        { effect = "fortifyattribute", attribute = "endurance", mag = 8, condition = { kind = "region", value = "Molag Amur" } },
        { effect = "weaknesstofrost", mag = 25, condition = { kind = "sun", value = "down" } },
      },
    },
  },
  { name = "Snow Prince",
    bonuses = {
      ...
      mid = {
        { effect = "resistfrost", mag = 10 },
        { effect = "resistmagicka", mag = 5 },
        { effect = "fortifyattack", mag = 10, condition = { kind = "sun", value = "up" } },
      },
      max = {
        { effect = "resistfrost", mag = 10 },
        { effect = "resistmagicka", mag = 5 },
        { effect = "fortifyattack", mag = 14, condition = { kind = "sun", value = "up" } },
        { effect = "sanctuary", mag = 12, condition = { kind = "sun", value = "up" } },
        { effect = "fortifyattribute", attribute = "agility", mag = 8, condition = { kind = "sun", value = "up" } },
      },
    },
  },
  { name = "Falmer",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstonormalweapons", mag = 15, condition = { kind = "sun", value = "up" } },
      },
      max = {
        { effect = "resistfrost", mag = 20 },
        ...
        { effect = "sanctuary", mag = 10 },
        { effect = "weaknesstonormalweapons", mag = 25, condition = { kind = "sun", value = "up" } },
      },
    },
  },
  { name = "Fighters Guild",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifyattack", mag = 5, condition = { kind = "faction", op = ">=", id = "Fighters Guild", value = 6 } },
      },
    },
  },
  { name = "Mages Guild",
    bonuses = {
      ...
      max = {
        ...
        { effect = "resistmagicka", mag = 12 },
        { effect = "fortifymagicka", mag = 8, condition = { kind = "faction", op = ">=", id = "Mages Guild", value = 6 } },
      },
    },
  },
  { name = "Thieves Guild",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifyattribute", attribute = "agility", mag = 8 },
        { effect = "fortifyskill", skill = "security", mag = 8, condition = { kind = "faction", op = ">=", id = "Thieves Guild", value = 6 } },
        { effect = "weaknesstonormalweapons", mag = 20, condition = { kind = "sun", value = "up" } },
      },
    },
  },
  { name = "Dark Brotherhood",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifyattack", mag = 8, condition = { { kind = "time", value = "night" }, { kind = "stance", value = "none" } } },
      },
    },
  },
  { name = "Morag Tong",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifyattack", mag = 5, condition = { kind = "faction", op = ">=", id = "Morag Tong", value = 6 } },
      },
    },
  },
  { name = "House Hlaalu",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifyattribute", attribute = "luck", mag = 8 },
        { effect = "fortifyskill", skill = "mercantile", mag = 8, condition = { kind = "faction", op = ">=", id = "Hlaalu", value = 6 } },
      },
    },
  },
  { name = "House Indoril",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifymagicka", mag = 8, condition = { kind = "faction", op = ">=", id = "Temple", value = 6 } },
      },
    },
  },
  { name = "House Dres",
  ...
  { name = "House Telvanni",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifymagicka", mag = 8, condition = { kind = "faction", op = ">=", id = "Telvanni", value = 6 } },
      },
    },
  },
  { name = "Templar",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstonormalweapons", mag = 15, condition = { kind = "bounty", op = ">=", value = 1000 } },
      },
      max = {
        { effect = "fortifyhealth", mag = 18 },
        { effect = "turnundead", mag = 20 },
        ...
        { effect = "resistmagicka", mag = 12 },
        { effect = "fortifyhealth", mag = 8, condition = { kind = "faction", op = ">=", id = "Temple", value = 6 } },
        { effect = "weaknesstonormalweapons", mag = 25, condition = { kind = "bounty", op = ">=", value = 1000 } },
      },
    },
  },
  { name = "Guard",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "resistnormalweapons", mag = 5 },
        { effect = "fortifyattack", mag = 8, condition = { kind = "time", value = "day" } },
        { effect = "weaknesstoshock", mag = 15, condition = { kind = "bounty", op = ">=", value = 1000 } },
      },
      max = {
        { effect = "fortifyhealth", mag = 18 },
        { effect = "resistnormalweapons", mag = 8 },
        { effect = "fortifyattack", mag = 12, condition = { kind = "time", value = "day" } },
        { effect = "fortifyattribute", attribute = "endurance", mag = 8 },
        { effect = "weaknesstoshock", mag = 25, condition = { kind = "bounty", op = ">=", value = 1000 } },
      },
    },
  },
  { name = "Royal Guard",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "resistnormalweapons", mag = 5 },
        { effect = "resistmagicka", mag = 8 },
        { effect = "weaknesstomagicka", mag = 15, condition = { kind = "bounty", op = ">=", value = 1000 } },
      },
      max = {
        { effect = "fortifyhealth", mag = 18 },
        { effect = "resistnormalweapons", mag = 8 },
        { effect = "resistmagicka", mag = 12 },
        { effect = "reflect", mag = 12, condition = { kind = "location", value = "interior" } },
        { effect = "weaknesstomagicka", mag = 25, condition = { kind = "bounty", op = ">=", value = 1000 } },
      },
    },
  },
  { name = "Her Hand",
    bonuses = {
      ...
      max = {
        ...
        { effect = "sanctuary", mag = 12, condition = { kind = "health", op = "<", value = 0.25, fraction = true } },
        { effect = "fortifyattribute", attribute = "willpower", mag = 8, condition = { kind = "faction", op = ">=", id = "Temple", value = 6 } },
      },
    },
  },
  { name = "Tribunal Temple",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "weaknesstofire", mag = 15, condition = { kind = "bounty", op = ">=", value = 1000 } },
      },
      max = {
        ...
        { effect = "restorehealth", mag = 2, dur = 1, condition = { kind = "location", value = "interior" } },
        { effect = "turnundead", mag = 20 },
        { effect = "fortifyskill", skill = "restoration", mag = 8, condition = { kind = "faction", op = ">=", id = "Temple", value = 6 } },
        { effect = "weaknesstofire", mag = 25, condition = { kind = "bounty", op = ">=", value = 1000 } },
      },
    },
  },
  { name = "Artifacts",
  ...
  { name = "Altmer",
    bonuses = {
      ...
      mid = {
        ...
        { effect = "fortifyattribute", attribute = "intelligence", mag = 5 },
        { effect = "fortifyskill", skill = "destruction", mag = 12, condition = { kind = "magicka", op = ">", value = 0.5, fraction = true } },
        { effect = "weaknesstomagicka", mag = 15, condition = { kind = "magicka", op = ">", value = 0.5, fraction = true } },
      },
      max = {
        { effect = "restoremagicka", mag = 2, dur = 1 },
        { effect = "fortifyattribute", attribute = "intelligence", mag = 8 },
        ...
        { effect = "weaknesstomagicka", mag = 25, condition = { kind = "magicka", op = ">", value = 0.5, fraction = true } },
      },
    },
  },
  { name = "Ancient Nordic",
  ...
  { name = "Companions",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifyhealth", mag = 22, condition = { kind = "health", op = "<", value = 0.5, fraction = true } },
        { effect = "fortifyattribute", attribute = "personality", mag = 8 },
        { effect = "fortifyattack", mag = 8, condition = { kind = "werewolf", value = true } },
      },
    },
  },
  { name = "Crown Guard",
  ...
  { name = "House Redoran",
    bonuses = {
      ...
      max = {
        ...
        { effect = "resistnormalweapons", mag = 8 },
        { effect = "fortifyattribute", attribute = "endurance", mag = 8 },
        { effect = "fortifyskill", skill = "spear", mag = 8, condition = { kind = "faction", op = ">=", id = "Redoran", value = 6 } },
      },
    },
  },
  { name = "Kagouti Hide",
  ...
  { name = "Red Dome Templar",
    bonuses = {
      ...
      max = {
        ...
        { effect = "restorehealth", mag = 3, dur = 1, condition = { kind = "health", op = "<", value = 0.25, fraction = true } },
        { effect = "fortifyskill", skill = "restoration", mag = 12 },
        { effect = "turnundead", mag = 15, condition = { kind = "faction", op = ">=", id = "Temple", value = 6 } },
        { effect = "weaknesstomagicka", mag = 25, condition = { kind = "bounty", op = ">=", value = 1000 } },
      },
    },
  },
  { name = "Redguard",
    bonuses = {
      ...
      max = {
        ...
        { effect = "fortifyattack", mag = 5, condition = { kind = "birthsign", value = "The Warrior" } },
        { effect = "weaknesstofire", mag = 25, condition = { kind = "location", value = "interior" } },
      },
    },
  },
